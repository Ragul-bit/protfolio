...
export const Certifications: React.FC = () => {
  ...
  return (
    <section id="certifications" className="py-10 md:py-14 overflow-hidden flex flex-col justify-center min-h-[calc(100vh-170px)]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
          {certificationsData.map((cert, index) => (
            <motion.div
              ...
              whileHover={{ y: -6 }}
              className="p-6 sm:p-7 rounded-2xl bg-white/80 hover:bg-white border border-slate-200/90 hover:border-blue-200 shadow-xs hover:shadow-md transition-all duration-300 flex flex-col justify-between group"
            >
